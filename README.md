http://localhost:8888/notebooks/Task%202%20_NUMPY%20Task.ipynb
...
# Check both the shape and the element values,values have to be exactly equalwithout tollerance
